define(["require", "exports", "../types/character/Characteristic", "../types/character/advancements/CharacterAdvancement", "../types/character/Aptitudes"], function (require, exports, Characteristic_1, CharacterAdvancement_1, Aptitudes_1) {
    "use strict";
    /**
     * Created by Damien on 7/29/2016.
     */
    class FinalizePageController {
        constructor($q, $scope, characterService, characteroptions, dice) {
            $q.all({
                ...
                $scope.toggleDisplayedCategory = function () {
                    switch ($scope.selectedCategory.value) {
                        ...
                        case "Characteristics":
                            setDisplayedOptions(Array.from(Characteristic_1.Characteristic.characteristics.values()));
                            break;
                    }
                    ;
                };
                            ...
                            case "Characteristics":
                                {
                                    ...
                                    advancement = new CharacterAdvancement_1.CharacteristicAdvancement($scope.displayedOption);
                                    break;
                                }
                            case "Skills":
                                {
                                    advancement = new CharacterAdvancement_1.SkillAdvancement($scope.displayedOption);
                                    break;
                                }
                            case "Talents":
                                advancement = new CharacterAdvancement_1.SkillAdvancement($scope.displayedOption);
                                break;
                            case "Psychic Powers":
                                advancement = new CharacterAdvancement_1.PsychicPowerAdvancement($scope.displayedOption);
                                break;
                        }
                ...
                $scope.buyAdvancement = function () {
                    ...
                    switch ($scope.selectedCategory.value) {
                        case "Characteristics":
                            ...
                            advancement = new CharacterAdvancement_1.CharacteristicAdvancement(value);
                            break;
                        case "Skills":
                            value = (characterService.character.skills().byName($scope.displayedOption.name.toLowerCase()) | -1) + 1;
                            advancement = new CharacterAdvancement_1.SkillAdvancement(value);
                            break;
                        case "Talents":
                            value = $scope.displayedOption.name;
                            advancement = new CharacterAdvancement_1.TalentAdvancement(value);
                            break;
                    }
                ...
                $scope.availableAptitudes = Aptitudes_1.Aptitudes.aptitudes.filter(function (aptitude) {
    ...
    exports.FinalizePageController = FinalizePageController;
});
//# sourceMappingURL=FinalizePageController.js.map