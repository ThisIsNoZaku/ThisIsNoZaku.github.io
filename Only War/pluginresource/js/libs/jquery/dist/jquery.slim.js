...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			input.setAttribute( "specialtyType", "hidden" );
...
function disableScript( elem ) {
	elem.type = ( elem.getAttribute( "specialtyType" ) !== null ) + "/" + elem.type;
	return elem;
}
function restoreScript( elem ) {
	...
	if ( match ) {
		...
		elem.removeAttribute( "specialtyType" );
	}
		...
		type: {
			set: function( elem, value ) {
				if ( !support.radioValue && value === "radio" &&
					...
					var val = elem.value;
					elem.setAttribute( "specialtyType", value );
					if ( val ) {
						elem.value = val;
					}
					return value;
